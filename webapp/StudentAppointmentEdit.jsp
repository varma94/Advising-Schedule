                ...
                <div>
                    <%
                        ...
                        if (request.getParameter("apptID") == null || request.getParameter("apptID)") == "" || request.getParameter("apptID").equals("")) {
                            ...
                            StudentAppointment appt = dm.getStudentAppointment(Integer.parseInt(request.getParameter("apptID")));
                            String advisorName = appt.getAdvisorName();
                            String studentMajor = appt.getStudentMajor();
                            String description = appt.getDescription();
                            String email = appt.getStudentEmail();
                    ...
                    <form name="edit" action="StudentAppointmentEdit.jsp" method="submit" role="form">
                        <%
                    ...
                    %>       
                    <jsp:useBean id="mab" class="uta.cse4361.beans.ModifyStudentAppointmentBean" scope="session"/>
                    ...
                    <%
                                ...
                                if (success.equals("")) {
                                    ...
                                    response.sendRedirect("AppointmentDetails.jsp?email="+email+"&aName=AppointmentCancelleted");
                                }
                            }
                        }
                    %>
